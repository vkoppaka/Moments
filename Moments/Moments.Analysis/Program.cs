			...
			var projects = new List<Solution> {
				...
				new Solution {
					...
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Moments.Droid/Moments.Droid.csproj"),
						Path.Combine(path, "../Moments.Shared/Moments.projitems")
					},
				},
				...
				new Solution {
					Name = "iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../Moments.iOS/Moments.iOS.csproj"),
						Path.Combine(path, "../Moments.Shared/Moments.projitems")
					},
				},
			};
